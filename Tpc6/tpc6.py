...
with open("C:/Users/marti/OneDrive/Ambiente de Trabalho/diabetes_prediction_dataset.csv", "r") as csv:
    csv.readline()
    for line in csv:
...
Destribution_gender(dataset)
Destribution_age(dataset)
Destribution_glucose(dataset)
